...
buttonAdd.addEventListener("click", function () {
    ...
    content.setAttribute("div", "content");
    ...
    */
    ...
    /*const colDescDiv = document.createElement("div");
    colDescDiv.setAttribute("div", "content");
    colDescDiv.classList.add("collectionName");
    colDescDiv.textContent = "Collection description will be here";
    content.appendChild(colDescDiv);
    */
